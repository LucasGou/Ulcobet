...
<html>
  ...
  <body>
    ...
    if(isset($_SESSION['username'])){
    	...
    	echo "<form action='parisresultats.php' method='POST' class='formul'><button class='deco' name='deco'>Se deconnecter </button></form>";
...
$req="SELECT * FROM Pari WHERE Statut=1";
